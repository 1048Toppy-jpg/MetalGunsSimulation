...
public class FirstPersonCharacter : MonoBehaviour
{
	...
	[SerializeField] private float runHighSpeed = 12f;                                       // The speed at which we want the character to move
	
	[SerializeField] private float strafeSpeed = 4f;                                    // The speed at which we want the character to be able to strafe
	[SerializeField] private float strafeHighSpeed = 8f;                                    // The speed at which we want the character to be able to strafe
	...
	public void FixedUpdate ()
	{
		...
		float sneakSpeed = strafeSpeed;
		if (Input.GetKey(KeyCode.LeftShift))
			sneakSpeed = strafeHighSpeed;
		...
		Vector3 desiredMove = transform.forward * input.y * speed + transform.right * input.x * sneakSpeed;
